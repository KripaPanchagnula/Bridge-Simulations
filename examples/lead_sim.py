...
def main():
    ...
    """
    dealer = Dealer([Hand([]), Hand([]), Hand.construct_from_str('Q9.8654.654.5432'), Hand([])], accept)
    deals = dealer.find_deals()
    simulation = BestLead(deals, "E", Hand.construct_from_str('Q9.8654.654.5432'),Contract.construct_from_str("3NT"))
